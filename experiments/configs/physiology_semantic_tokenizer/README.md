...
| --- | --- | --- |
| `ssm_band_geometry_v1.yaml` | Local multichannel, merged/split bands, geometry/permutation, matched lagged linear controls | [Structure protocol](../../../docs/EXPERIMENT_PLAN.md#分频带与空间软约束测试2026-09-17); same six-state Gaussian MAP, training-only loading regression and nested selection, no teacher qualification |
