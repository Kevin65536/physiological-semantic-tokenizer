...
def main():
    ...
    parser.add_argument('--stage',choices=['reference','a0','a1','review','report'],required=True)
...
def run_candidate_scope_review(cfg,run_dir,teacher_dir):
    ...
    for candidate,result in summary['candidates'].items():
        ...
        if old['laws']!=result['laws'] or any(old['checks'][key]!=value for key,value in result['checks'].items() if key!='complete_registered_cases'):
